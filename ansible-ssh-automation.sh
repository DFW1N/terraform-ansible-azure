...
echo -e "\e[95mPlease type input values for your SSH or just press enter for default.\n";
ssh-keygen -t rsa;
chmod 755 ~/.ssh;
touch ~/.ssh/authorized_keys;
chmod 644 ~/.ssh/authorized_keys;
echo -e "\e[95mPlease type input value of YES to continue for the authenticity of host 127.0.0.1\n";
