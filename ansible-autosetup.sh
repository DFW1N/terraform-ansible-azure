...
echo "Please use \e[101m sudo passwd ansible \e[49m to create the user account password and complete setup with \e[101m ssh-keygen \e[49m command.";
echo "\e[101m---------------------------------------------------------------------------------------------------------------------------------------------";
